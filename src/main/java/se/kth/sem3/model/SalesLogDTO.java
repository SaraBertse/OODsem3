...
/**
 * The sales log keeps information for the receipt and the external systems. It
 * stores: Date of sale, time of sale, store name, store address, name of each
 * item, quantity of each item, price for each item, total price of sale, VAT
 * for the sale, amount paid and change.
 */
