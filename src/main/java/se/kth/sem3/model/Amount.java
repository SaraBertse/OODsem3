...
public class Amount {
     ...
     *
     * @return Returns <code>true</code> if the amount passed to the method has
     * the same value as this amount. Returns <code>false</code> if the two
     ...
     * @return The result of the existing <code>Amount</code> minus the new
     * <code>Amount</code>.
     */
    ...
    /**
     * Multiplies the current <code>Amount</code> times another
     * <code>Amount</code>.
     *
