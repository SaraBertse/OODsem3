...
/**
 * This is the class that handles the communication between the program and the
 * external inventory.
 */
public class ExternalInventoryDBHandler {
    ...
    /**
     * Is a shell method for updating the external inventory. Since there is no
     * real inventory, the method is empty.
     *
